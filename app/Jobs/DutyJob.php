...
class DutyJob implements ShouldQueue
{
     ...
     * @var string
     */
    private $subject = 'Citycenter research process: Pending DT Collection. Potential written-off to your city center';
    ...
    {
        $name = "PENDING_DT_".now()->format('YmdHis').'_'.Str::random(9).".xlsx";
        ...
        $ccs = implode(', ', $agents);
        $template = (new Mail\DutyMail($this->collection, $this->secondRequest))->render();
